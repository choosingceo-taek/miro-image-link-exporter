...
- 링크 669개 · `<img>` 321개 · iframe 13개
- 링크 중 이미지가 딸린 것 173개 → 그중 주소를 뽑아낸 것 **173개**

**주소를 찾은 속성**: `src` 173

**성공한 카드의 class**: `x-link-to qa-x-link-to _tile-link_1loo4i` 150 · `images_Dzl3I` 14 · `container_2ZJCi with-columns_yaY1x` 7 · `_container_1eekmh aerie-theme` 2
